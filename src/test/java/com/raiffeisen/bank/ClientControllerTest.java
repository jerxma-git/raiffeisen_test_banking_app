...
public class ClientControllerTest {
    ...
    Client sampleClient = new Client(null, "sample_client_firstName", "sample_client_lastName", "sample_client_email@mail.domain");
    ...
    Map<String, Client> invalidClients = Map.of(
        "no_lastName_client", new Client(null, "no_last_name_client_firstName", null, "no_lastName_client_email@mail.domain"),
        "no_firstName_client", new Client(null, null, "no_firstName_client_name", "no_firstName_client_email@mail.domain"),
