...
public class AccountControllerTest {
    ...
    void testDepositToAccount() throws Exception {
        ...
        // Mockito.when(accountService.getAccountByAccountNumber(argThat(accNum -> !accNum.equals(accountNumber)))).thenReturn(null);

        Mockito.when(accountService.applyAccountBalanceDelta(eq(accountNumber), Mockito.anyDouble()))
            .thenReturn(true);

        Mockito.when(accountService.applyAccountBalanceDelta(argThat(accNum -> !accNum.equals(accountNumber)), Mockito.anyDouble()))
            .thenReturn(false);
